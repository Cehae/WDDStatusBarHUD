...
@implementation WDDStatusBarHUD
...
+ (void)showSuccess:(NSString *)msg
{
    ...
    [self showMessage:msg image:[UIImage imageNamed:@"WDDStatusBarHUD.bundle/success"]];
}
...
{
    [self showMessage:msg image:[UIImage imageNamed:@"WDDStatusBarHUD.bundle/error"]];
}
